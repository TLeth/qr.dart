...
class InputTooLongException implements Exception {
  ...
  InputTooLongException._internal(this.providedInput, this.inputLimit, this.message);
  ...
  factory InputTooLongException(int providedInput, int inputLimit) {
    ...
    return new InputTooLongException._internal(providedInput, inputLimit, message);
  }
